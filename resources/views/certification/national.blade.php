...
@section('content')
			...
			<div class="fancy-hero-six">
				<div class="container">
					...
					<p class="sub-heading" style="color: white">Raih Sertifikasi Nasional berstandard SKKNI dari BNSP bidang Desain, UI/UX dan Produk. Ikuti Pelatihan Singkat dan Sertifikasi-nya melalui BISA Design Academy.</p>
				</div>
								...
								<a class="block-style-twentyTwo" href="/certification/detail/{{ $dat['id_certification'] }}" style="border-radius:30px; background:linear-gradient(180deg, #D9D9D9 0%, rgba(217, 217, 217, 0) 100%); display:block; color: inherit">
                                    ...
                                    <div class="grid-container mt-3" style="display:grid; grid-template-columns: 50% 50% ;">
										...
										<div class="grid-item text-right">
                                            ...
                                            @endphp
											<strong style="color: white">Rp. {{ $dat['harga'] }}</strong>
										</div>
...
$(document).ready(function(){
    ...
    function showTransaksi(){
        var settings = {
            "url": "https://gate.bisaai.id/bisa_design_prod/certification/get_certification?tipe=2&is_aktif=1",
            "method": "GET",
            "timeout": 0,
            "data": {
                search: $('#cari').val(),
