			...
			<div class="user-data-page clearfix d-lg-flex" >
				...
				<div class="form-wrapper">
					<div class="d-flex justify-content-between">
						...
						<a href="/" class="go-back-button" style="color: white; font-weight:700; font-size:20px">Back To home</a>
					</div>
					...
					<div class="alert alert-danger alert-dismissible fade show" role="alert" style="position:fixed; top:50px; right:10px; z-index:9999">
					...
					@if(session()->has('successGantiPass'))
					<div class="alert alert-success alert-dismissible fade show" role="alert" style="position:fixed; top:50px; right:10px; z-index:9999">
						{{ session()->get('successGantiPass') }}
						<button type="button" class="close" data-dismiss="alert" aria-label="Close">
						  <span aria-hidden="true">&times;</span>
						</button>
					</div>
					...
					<form action="/login" method="POST" class="user-data-form mt-20 md-mt-40">
						@csrf
						...
						<div class="row" style="margin-top: 100px">
							...
							<div class="col-12">
								<div class="input-group-meta mb-8">
									<label>Masukkan Password</label>
									<input type="password" placeholder="Enter Password" class="pass_log_id" name="password" id="password" required autocomplete="on">
									<span class="placeholder_icon"><span class="passVicon"><img src="{{ asset('images/icon/view.svg') }}" alt=""></span></span>
								</div>
							</div>

							<div class="col-12 mt-4">
								<button type="submit" class="theme-btn-fourteen mt-50 mb-50 m-auto">LOGIN</button>
							</div>
