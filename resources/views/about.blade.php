...
<html lang="en">
	...
	<body>
		<div class="main-page-wrapper">
						   ...
						   <div class="navbar-collapse collapse" id="navbarSupportedContent">
						   		<div class="d-lg-flex align-items-center">
						   			<ul class="navbar-nav">
								        ...
								        <li class="nav-item dropdown">
								            ...
								            <ul class="dropdown-menu">
									            <li>
									            	<a href="portfolio-V1.html" class="dropdown-item">Classic Style</a>
									            </li>
									            <li>
									            	<a href="portfolio-V2.html" class="dropdown-item">Grid 2 Columns</a>
									            </li>
									            <li>
									            	<a href="portfolio-V3.html" class="dropdown-item">Grid 3 Columns</a>
									            </li>
									            <li>
									            	<a href="portfolio-V4.html" class="dropdown-item">Gallery Slider</a>
									            </li>
									            <li>
									            	<a href="portfolio-V5.html" class="dropdown-item">Grid Single</a>
									        	</li>
									        	<li>
							                ...
							                <ul class="dropdown-menu">
								                <li>
								                	<div class="row">
								                		<div class="col-lg-3">
								                			<div class="menu-column">
								                				...
								                				<ul class="mega-dropdown-list">
													                ...
													                <li><a href="about-us(event).html" class="dropdown-item">Event Organiser</a></li>
													                <li><a href="about-us(management).html" class="dropdown-item">Project Management</a></li>
													                <li><a href="about-us(doc).html" class="dropdown-item">Documentation</a></li>
								                				</ul>
								                				<h6 class="mega-menu-title">Team</h6>
								                				<ul class="mega-dropdown-list">
								                					<li><a href="team-V1.html" class="dropdown-item">Team Version 01</a></li>
										                			<li><a href="team-V2.html" class="dropdown-item">Team Version 02</a></li>
										                			<li><a href="team-single.html" class="dropdown-item">Team Details</a></li>
								                				</ul>
								                		...
								                		<div class="col-lg-3">
								                			<div class="menu-column">
								                				<h6 class="mega-menu-title">Pricing</h6>
								                				<ul class="mega-dropdown-list">
								                					<li><a href="pricing(cs).html" class="dropdown-item">Customer Support</a></li>
										                			<li><a href="pricing(event).html" class="dropdown-item">Event Organiser</a></li>
										                			<li><a href="pricing(management).html" class="dropdown-item">Project Management</a></li>
								                				</ul>
								                				<h6 class="mega-menu-title">Contact Us</h6>
								                				<ul class="mega-dropdown-list">
								                					<li><a href="contact-us(cs).html" class="dropdown-item">Customer Support</a></li>
													                <li><a href="contact-us(event).html" class="dropdown-item">Event Organiser</a></li>
													                <li><a href="contact-us(management).html" class="dropdown-item">Project Management</a></li>
													                <li><a href="contact-us(doc).html" class="dropdown-item">Documentation</a></li>
								                				</ul>
								                			</div>
								                		</div>
								                		<div class="col-lg-3">
								                			<div class="menu-column">
								                				...
								                				<ul class="mega-dropdown-list">
								                					<li><a href="service-v1.html" class="dropdown-item">Service Version 01</a></li>
													                <li><a href="service-v2.html" class="dropdown-item">Service Version 02</a></li>
													                <li><a href="service-v3.html" class="dropdown-item">Service Version 03</a></li>
													                <li><a href="service-v4.html" class="dropdown-item">Service Version 04</a></li>
													                <li><a href="service-detailsV1.html" class="dropdown-item">Service Details</a></li>
								                				</ul>
								                				<h6 class="mega-menu-title">Feature</h6>
								                				<ul class="mega-dropdown-list">
								                					<li><a href="solution(managment).html" class="dropdown-item">Our Solution</a></li>
									            					<li><a href="product(cs).html" class="dropdown-item">Product Feature</a></li>
									            					<li><a href="features(cs).html" class="dropdown-item">Our Features</a></li>
								                				</ul>
								                			</div>
								                		</div>
								                		<div class="col-lg-3">
								                			<div class="menu-column">
								                				...
								                				<ul class="mega-dropdown-list">
								                					...
								                					<li><a href="faq-details.html" class="dropdown-item">Faq Details</a></li>
								                					<li><a href="terms-and-condition.html" class="dropdown-item">Terms & Condition</a></li>
													                <li><a href="login.html" class="dropdown-item">Login</a></li>
													                <li><a href="sign-up.html" class="dropdown-item">Signup</a></li>
								        ...
								        <li class="nav-item dropdown">
								            ...
								            <ul class="dropdown-menu">
								            	<li class="dropdown-submenu dropdown">
									            	<a href="#" class="dropdown-item dropdown-toggle" data-toggle="dropdown">Third Level Menu</a>
									            	<ul class="dropdown-menu">
									            ...
									            <li>
									            	<a href="blog-v1.html" class="dropdown-item">Blog Version 01</a>
									            </li>
									            <li>
									            	<a href="blog-v2.html" class="dropdown-item">Blog Version 02</a>
									            </li>
									            <li>
									            	<a href="blog-v3.html" class="dropdown-item">Blog Version 03</a>
									            </li>
									            <li>
									            	<a href="blog-v4.html" class="dropdown-item">Blog Version 04</a>
									            </li>
									            <li>
								        ...
								        <li class="nav-item dropdown">
								            ...
								            <ul class="dropdown-menu">
								            	<li>
									            	<a href="doc-fullwidth.html" class="dropdown-item">Full Width</a>
									            </li>
									            <li>
									            	<a href="doc-fullwidth-banner.html" class="dropdown-item">Full Width Banner</a>
									            </li>
									            <li>
									            	<a href="doc-box.html" class="dropdown-item">Doc Box</a>
									            </li>
									            <li>
									            	<a href="doc-box-banner.html" class="dropdown-item">Doc Box with Banner</a>
									            </li>
									            <li>
									...
									<ul class="right-button-group d-flex align-items-center justify-content-center">
								   		<li>
											<a href="login.html" class="signIn-action">Login</a>
										</li>
										<li>
											<a href="sign-up.html" class="signUp-action">Get Started</a>
										</li>
									</ul>
						   		</div>
						   	</div>
				...
				<div class="container">
					<div class="row align-items-center">
						<div class="col-lg-6 col-md-7 col-sm-8 m-auto">
							<img src="images/media/img_05.png" alt="">
						</div>
						<div class="col-lg-6">
			...
			=====================================================
			-->
			<div class="counter-info-standard pt-70 pb-45">
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="1200">
							<div class="counter-box-two">
								<h2 class="number"><span class="timer" data-from="0" data-to="1500" data-speed="1500" data-refresh-interval="5">0</span>+</h2>
								<em>Positive Review</em>
						      	<p class="font-rubik">A place to think and track ideas</p>
							</div> <!-- /.counter-box-two -->
						</div>
						<div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
							<div class="counter-box-two">
								<h2 class="number"><span class="timer" data-from="0" data-to="200" data-speed="1200" data-refresh-interval="5">0</span>+</h2>
								<em>Branches</em>
						      	<p class="font-rubik">A home for your iqu team, best</p>
							</div> <!-- /.counter-box-two -->
						</div>
						<div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
							<div class="counter-box-two">
								<h2 class="number"><span class="timer" data-from="0" data-to="2" data-speed="1200" data-refresh-interval="5">0</span>k</h2>
								<em>Work Done</em>
						      	<p class="font-rubik">Beautiful docs for your APIs, Products</p>
							</div> <!-- /.counter-box-two -->
						</div>
					</div>
				</div>
			</div> <!-- /.counter-info-standard -->
				...
				<div class="container">
					<div class="row align-items-center">
						...
						<div class="col-lg-6 col-md-8 m-auto" data-aos="fade-left" data-aos-duration="1200">
							<img src="images/media/img_06.png" alt="" class="fancy_img_media">
						</div>
					</div>
				</div>
			</div> <!-- /.fancy-text-block-two -->
					...
					<div class="row">
						<div class="col-xl-11 m-auto">
							<div class="row no-gutters">
								<div class="col-lg-6">
									<div class="feature-content light-bg">
										<div class="header" data-aos="fade-up" data-aos-duration="1200">
											<h3>Individual</h3>
											<p class="font-rubik">Wzprenr Investor Network is a global community that extends the reach of leading</p>
										</div> <!-- /.header -->

										<div class="feature-list d-flex" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
											<div class="icon-box d-flex align-items-center justify-content-center"><img src="images/icon/07.svg" alt=""></div>
											<div class="text-meta">
												<h4>Time well spent</h4>
												<p>Facilitates access to capital entrepreneurs through road show preparation.</p>
											</div> <!-- /.text-meta -->
										</div> <!-- /.feature-list -->
										<div class="feature-list d-flex" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
											<div class="icon-box d-flex align-items-center justify-content-center"><img src="images/icon/08.svg" alt=""></div>
											<div class="text-meta">
												<h4>Quietly powerful</h4>
												<p>Let intuition be your guide. We get out of your way and fight the friction in your team’s workflow so you don’t have to.</p>
											</div> <!-- /.text-meta -->
										</div> <!-- /.feature-list -->
									</div> <!-- /.feature-content -->
								</div>
									...
									<div class="feature-content dark-bg">
										...
										<div class="feature-list d-flex" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
											...
											<div class="text-meta">
												...
												<p>Remove the fog. We don’t want to be another task to complete or a tool to decipher.</p>
											</div> <!-- /.text-meta -->
										</div> <!-- /.feature-list -->
										<div class="feature-list d-flex" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
											<div class="icon-box d-flex align-items-center justify-content-center"><img src="images/icon/08.svg" alt=""></div>
											<div class="text-meta">
												...
												<p>Software is made better together. From task completion to product launch, we celebrate team wins big and small.</p>
											</div> <!-- /.text-meta -->
										</div> <!-- /.feature-list -->
									</div> <!-- /.feature-content -->
								</div>
			...
			=====================================================
			-->
			<div class="team-section-one pt-150 md-pt-100">
				<div class="container">
			        ...
			        <div class="mixitUp-container">
			            <div class="mix designer developer">
			            	<div class="team-member" onclick="location.href='team-single.html';">
			            		<img src="images/media/img_07.png" alt="">
			            		<h4>Maurice Craig</h4>
			            ...
			            <div class="mix leadership marketing">
			            	<div class="team-member" onclick="location.href='team-single.html';">
			            		<img src="images/media/img_08.png" alt="">
			            		<h4>Duane Cain</h4>
			            ...
			            <div class="mix developer marketing">
			            	<div class="team-member" onclick="location.href='team-single.html';">
			            		<img src="images/media/img_09.png" alt="">
			            		<h4>Viola George</h4>
			            		<strong>Co-Founder</strong>
			            	</div> <!-- /.team-member -->
			            </div> <!-- /.mix -->
			            <div class="mix leadership marketing">
			            	<div class="team-member" onclick="location.href='team-single.html';">
			            		<img src="images/media/img_10.png" alt="">
			            		<h4>Maurice Craig</h4>
			            		<strong>Co-Founder</strong>
			            	</div> <!-- /.team-member -->
			            </div> <!-- /.mix -->
			            ...
			            <div class="mix designer marketing">
			            	<div class="team-member" onclick="location.href='team-single.html';">
			            		<img src="images/media/img_11.png" alt="">
			            		<h4>Nina Walters</h4>
			            		<strong>Senior Product Desogner</strong>
			            	</div> <!-- /.team-member -->
			            </div> <!-- /.mix -->
			            <div class="mix developer marketing">
			            	<div class="team-member" onclick="location.href='team-single.html';">
			            		<img src="images/media/img_12.png" alt="">
			            ...
			            <div class="mix leadership developer">
			            	<div class="team-member" onclick="location.href='team-single.html';">
			            		<img src="images/media/img_13.png" alt="">
			            		<h4>Maurice Craig</h4>
			            		<strong>Co-Founder</strong>
			            	</div> <!-- /.team-member -->
			            </div> <!-- /.mix -->
			            <div class="mix marketing leadership">
			            	<div class="team-member" onclick="location.href='team-single.html';">
			            		<img src="images/media/img_14.png" alt="">
			            		<h4>Viola George</h4>
			            		<strong>Co-Founder</strong>
			            	</div> <!-- /.team-member -->
			            </div> <!-- /.mix -->
			            ...
			            <div class="mix designer leadership">
			            	<div class="team-member" onclick="location.href='team-single.html';">
			            		<img src="images/media/img_15.png" alt="">
			            		<h4>Viola George</h4>
			            		<strong>Co-Founder</strong>
			            	</div> <!-- /.team-member -->
			            </div> <!-- /.mix -->
			            <div class="mix leadership marketing">
			            	<div class="team-member" onclick="location.href='team-single.html';">
			            		<img src="images/media/img_16.png" alt="">
			            		<h4>Viola George</h4>
			            		<strong>Co-Founder</strong>
			            	</div> <!-- /.team-member -->
			            </div> <!-- /.mix -->
			            <div class="mix developer designer">
			            	<div class="team-member" onclick="location.href='team-single.html';">
			            		<img src="images/media/img_17.png" alt="">
			            		<h4>Viola George</h4>
			            		<strong>Co-Founder</strong>
			            	</div> <!-- /.team-member -->
			            </div> <!-- /.mix -->
			            <div class="mix designer">
			            	<div class="team-member" onclick="location.href='team-single.html';">
			            		<img src="images/media/img_18.png" alt="">
			            		<h4>Viola George</h4>
			            		<strong>Co-Founder</strong>
			            	</div> <!-- /.team-member -->
			            </div> <!-- /.mix -->
			...
			=====================================================
			-->
			<div class="useable-tools-section bg-color mt-50 md-mt-10">
				<div class="container">
			...
			<div class="feature-blog-one pt-170 pb-120 md-pt-100 md-pb-60">
				<div class="container">
					<div class="header d-md-flex align-items-center justify-content-between mb-90 md-mb-40">
						...
						<a href="blog-v1.html" class="theme-btn-one sm-mt-30">Go to Blog</a>
					</div>

					<div class="row justify-content-center">
						<div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1200">
							<div class="post-meta">
								<img src="images/blog/media_01.png" alt="" class="image-meta">
						...
						<div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
							<div class="post-meta">
								<img src="images/blog/media_02.png" alt="" class="image-meta">
						...
						<div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">
							<div class="post-meta">
								<img src="images/blog/media_03.png" alt="" class="image-meta">
					...
					<div class="row align-items-center">
						...
						<div class="col-lg-6">
							<div class="form-wrapper">
								...
								<p class="font-rubik">Already a member? <a href="#">Sign in.</a></p>
							</div> <!-- /.form-wrapper -->
						</div>
					</div>
				</div> <!-- /.container -->
			...
			=====================================================
			-->
			<footer class="theme-footer-one pt-130 md-pt-80">
				<div class="top-footer">
					<div class="container">
						<div class="row justify-content-end">
							<div class="col-lg-3 col-md-12 footer-about-widget" data-aos="fade-up" data-aos-duration="1200">
								<a href="index.html" class="logo"><img src="images/logo/deski_02.svg" alt=""></a>
							</div> <!-- /.about-widget -->
							...
							<div class="col-lg-3 col-md-4 footer-list" data-aos="fade-up" data-aos-duration="1200" data-aos-delay="100">
								...
								<ul>
									<li><a href="about-us(management).html">About us</a></li>
				...
				<div class="container">
					<div class="bottom-footer-content">
						<div class="d-sm-flex align-items-center justify-content-between">
							<ul class="order-sm-last" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="100" data-aos-anchor=".theme-footer-one">
								<li><a href="#">Privacy</a></li>
								<li><a href="#">Security</a></li>
								<li><a href="#">Terms</a></li>
							</ul>
							<p class="order-sm-first" data-aos="fade-right" data-aos-duration="1200" data-aos-delay="100" data-aos-anchor=".theme-footer-one">Copyright @2021 deski inc.</p>
						</div>
					</div> <!-- /.bottom-footer -->
				</div>
